		...
		<div class="box">
			<div class="left">
				...
				<div class="timg2">
					...
					<div class="center">
						<span><img src="images/icon_2.jpg" alt=""></span> <span><img
							src="images/icon_3.jpg" alt=""></span> <span><img
							src="images/icon_2.jpg" alt=""></span> <span><img
							src="images/icon_3.jpg" alt=""></span> <span><img
							src="images/icon_2.jpg" alt=""></span>
					</div>
					<div class="rg">
			...
			<div class="cent">
				...
				<div class="bg">
					<p>
						市场价：<strong>￥${obj_sku.jg}</strong>
					</p>
					<p>
						促销价：<strong>￥${obj_sku.jg}</strong>
					</p>
				</div>
				<div class="clear">
					...
					<c:forEach items="${list_sku}" var="sku">
						<div class="min_mx">
							<a href="goto_sku_detail.do?sku_id=${sku.id}&spu_id=${sku.shp_id}">${sku.sku_mch}</a>
						</div>
					</c:forEach>
				</div>
				<div class="clear">
	...
	<div class="Dbox1">
		<div class="boxbottom">
			...
			<div class="btm">
				...
				<c:forEach items="${obj_sku.list_img}" var="image">
